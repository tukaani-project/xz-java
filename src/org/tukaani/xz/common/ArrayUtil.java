 ...
 * 
 * <p>
 * The means of comparing arrays can be controlled by setting the system
 * property {@code org.tukaani.xz.ArrayComparison} to a value from
...
public final class ArrayUtil {
    ...
    /**
     * Enumerated options for controlling implementation of how to compare
     * arrays.
     */
        ...
        static ArrayComparison getFromProperty(String prop) {
            ...
            try {
                ...
                logger.log(Level.INFO,
                        "Invalid ArrayComparison option, using default behavior",
                        e);
                return null;
            }
        }
    ...
    static {
        ...
        logger.log(Level.FINE, "ArrayMismatch implementation chosen: {0}",
     ...
     * @param aFromIndex The first offset into <i>bytes</i> to start reading
     *                   from.
     * @param bFromIndex The second offset into <i>bytes</i> to start reading
     *                   from.
     * @param length     The number of bytes to compare.
     * @return The offset from the starting indexes of the first byte which
     *         differs. If all match, <i>length</i> will be returned.
     */
     ...
     * {@code byte} which differs.
     * <p>
     * This differs from {@link #mismatch(byte[], int, int, int)} by optimizing
     * for the case where the first bytes compared do not match.
     * </p>
     * 
     * @param bytes      The {@code byte[]} for comparison.
     * @param aFromIndex The first offset into <i>bytes</i> to start reading
